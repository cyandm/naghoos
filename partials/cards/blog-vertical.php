...
<a href="<?php echo esc_url(get_the_permalink($post_id)); ?>" class="blog-card group flex w-full flex-row items-stretch gap-2">
    ...
    <div class="flex flex-col justify-center gap-4">
        ...
        <div class="flex w-full items-center justify-between gap-0 text-xs font-medium text-cynBlack/40">
