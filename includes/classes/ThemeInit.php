...
class ThemeInit
{
	...
	public static function init()
	{
		...
		//Scripts — dequeue conflicting styles before theme CSS; load theme CSS last
		add_action('wp_enqueue_scripts', [__CLASS__, 'dequeueConflictingStyles'], 100);
		add_action('wp_enqueue_scripts', [__CLASS__, 'frontendEnqueueScripts'], 999);
	...
	public static function dequeueConflictingStyles()
	{
		// Block / WooCommerce styles that may ship Tailwind v3 preflight resets
