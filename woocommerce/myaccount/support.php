...
<section class="bg-white border border-cynBlack/10 rounded-2xl px-4 py-5 md:px-6 md:py-6">
    ...
    <div class="flex flex-col gap-3">
        ...
        <form
            ...
            <label for="support-message" class="relative flex">
                <div class="size-5 text-cynBlack/60 absolute start-3 top-4">
            ...
            <div class="flex justify-start md:justify-end">
                <button id="support-submit-btn" type="submit" class="primary-btn !px-8 max-md:w-full inline-flex items-center justify-center gap-2">
                    ...
                    <span data-submit-loading class="hidden items-center gap-2">
                        <span class="inline-block size-4 border-2 border-cynWhite/40 border-t-cynWhite rounded-full animate-spin"></span>
