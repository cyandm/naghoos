...
<form method="get" action="<?php echo esc_url($form_action); ?>" class="price-filter-form">
	<div class="price_slider_wrapper flex flex-col items-center">
		<div class="price_slider w-[95%] lg:w-[92%]" style="display:none;"></div>
		<div class="price_slider_amount" data-step="<?php echo esc_attr($step); ?>">
			<div class="flex flex-wrap items-center gap-2 mb-3">
				<label for="min_price" class="text-xs font-medium text-cynBlack shrink-0"><?php esc_html_e('شروع از', 'naghoos'); ?></label>
				...
				<span class="text-xs font-medium text-cynBlack shrink-0"><?php esc_html_e('تا', 'naghoos'); ?></span>
