...
<div id="comments" class="blog-comments bg-cynWhite p-4 md:p-6 rounded-3xl border border-cynBlack/10">
    ...
    <div id="review_form_wrapper">
        ...
        $comment_form = array(
            ...
            'label_submit' => __('ارسال دیدگاه', 'naghoos'),
            'logged_in_as' => '',
            'comment_field' => '',
        ...
        if (get_option('comment_registration') && !is_user_logged_in()) {
            $comment_form['must_log_in'] = '<p class="must-log-in text-gray-500 mb-4">' . sprintf(__('برای ارسال دیدگاه باید %1$sوارد%2$s شوید.', 'naghoos'), '<a href="' . esc_url(wp_login_url(get_permalink())) . '" class="text-cynOrange">', '</a>') . '</p>';
        }
